...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post branches_url, params: { branch: { address: @branch.address, city: @branch.city, name: @branch.name, type: @branch.type } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { address: @branch.address, city: @branch.city, name: @branch.name, type: @branch.type } }
